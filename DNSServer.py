            ...
            if qname in dns_records and qtype in dns_records[qname]:
                ...
                if qtype == dns.rdatatype.MX:
                    for data in answer_data:
                        rdata_list.append(MX(dns.rdataclass.IN, dns.rdatatype.MX, 0, data))
                    ...
                    if isinstance(answer_data, str):
                        ...
                        rdata_list = [dns.rdata.from_text(str(dns.rdataclass.IN), str(qtype), str(data)) for data in answer_data]
